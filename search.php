...
if (isset($_GET["search"])){
    $sql = "SELECT * FROM ALERTE WHERE titre_alerte LIKE '%" . mysqli_real_escape_string($con, htmlentities($_GET['search'])) . "%' OR message_alerte LIKE '%" . mysqli_real_escape_string($con, $_GET['search']) . "%'";
