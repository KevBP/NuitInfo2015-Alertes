        ...
        <div class="col-lg-6">
            ...
            if ($result->num_rows > 0) {
                ...
                while($row = $result->fetch_assoc()) {
                    echo '<button type="button" class="btn btn-primary list-group-item" data-toggle="modal" data-target="#exampleModal" data-whatever="'.$row["titre_alerte"].'"><h4 class="list-group-item-heading" data-whatever="'.$row["titre_alerte"].'">'. $row["titre_alerte"] .'</h4><p class="list-group-item-text">' . $row["message_alerte"] . '</p></button>';
